...
int main(){
    try{
        ...
        // for (auto elemento : f_abs(originalMatrix, 255))
        // {
        //     cout << elemento << " ";
        // }

        // for (auto elemento : f_rel(f_abs(originalMatrix, 255)))
        // {
        //     printf("%0.9f", elemento);
        // }

        cout << Media(originalMatrix) << endl;

        printf("%0.9f", Var(originalMatrix));
